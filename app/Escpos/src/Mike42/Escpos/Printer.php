...
use Mike42\Escpos\PrintConnectors\PrintConnector;
 ...
 require_once app_path('Escpos/src/Mike42/Escpos/CapabilityProfile.php');
 require_once app_path('Escpos/src/Mike42/Escpos/PrintBuffers/EscposPrintBuffer.php');
  require_once app_path('Escpos/src/Mike42/Escpos/PrintBuffers/PrintBuffer.php');
   require_once app_path('Escpos/src/Mike42/Escpos/PrintConnectors/PrintConnector.php');
/**
