...
<div class="wrapper">
    ...
    <nav id="sidebar" style="display: none;">
        ...
        <ul class="list-unstyled components">
            <li>
                <a href="{{ route('royalplatter.index', ['table' => session('table_name')]) }}"><i class="fa fa-home" style="margin-right: 10px;" aria-hidden="true"></i> Home</a>
            </li>
            ...
            @endif -->
            <li>
                <a href="{{ route('royalplatter.myorder') }}"><i class='fas fa-shopping-bag' style="margin-right: 10px;"></i> My Orders</a>
            </li>
            <!-- <li>
                @if (Session::get('session_code')) 
    ...
    <div id="main">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container-fluid">
                <!-- <a href="{{ route('royalplatter.index', ['table' => session('table_name')]) }}">
                    <img src="{{asset('assets/img/final.jpg')}}" height="70px" width="90px" alt="Smart-BI">
                </a> -->
                <?php if (Session::get('logo')) { ?>
                    <a href="{{route('royalplatter.index', ['table' => session('table_name')])}}"><img src="{{ url('restaurant_logo/' . Session::get('logo')) }}" height="70px" width="90px" /></a>

                <?php } else { ?>
                    <a href="{{route('royalplatter.index', ['table' => session('table_name')])}}"><img src="{{asset('assets/img/final.jpg')}}" height="70px" width="90px" alt="royalplatter"></a>
                <?php } ?>
