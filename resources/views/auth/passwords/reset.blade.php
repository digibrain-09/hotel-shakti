...
<body class="font-sans bg-white min-h-screen overflow-x-hidden">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative">
            ...
            <div class="absolute bottom-8 left-8 text-white">
                ...
                <p class="text-lg opacity-90">Manage your culinary creations with ease</p>
            </div>
        </div>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white border border-border rounded-card p-8 shadow-lg">
                   ...
                   @error('password') border-error @enderror"
                                    name="password" tabindex="2" required autocomplete="password" autofocus>
                   ...
                   focus:outline-none focus:ring-2 focus:ring-primary
                   @error('password') border-error @enderror"
                                    name="password_confirmation" tabindex="2" required autocomplete="new-password" autofocus>
                                <div class="input-group-append px-4 py-3" id="toggle_password2" style="margin-left: -50px;">
                                    <span class="input-group-text" style="cursor:pointer;">
                                        <i class="fa fa-eye-slash" aria-hidden="true"></i>
                                    </span>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var $toggleBtn2 = $('#toggle_password2');

            var $icon = $('#toggle_password i');
            var $icon2 = $('#toggle_password2 i');
